    ...
    <div className="relative  mx-auto my-2 lg: flex w-full max-w-[300px] flex-col overflow-hidden rounded-[20px] border border-gray-100 bg-white shadow-md">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <button
          ...
          className="flex items-center w-full justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-800 focus:outline-none"
        >
