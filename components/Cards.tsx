...
const Cards = ({scrapImage, scrapTitle} : any) => {
    return (
        <>
                <div className="w-full sm:w-full md:w-1/2 lg:w-1/4 px-1 mb-4">
                    <div className="bg-white py-6 rounded-3xl shadow-md flex flex-col items-center cursor-pointer transition-transform duration-300 hover:shadow-gray-600">
                        <Image className="w-[355px] object-cover mb-4 rounded-3xl " src={scrapImage} alt="Card Image" />
                        ...
                        <div className='w-full grid grid-cols-2 px-7 mt-5'>
